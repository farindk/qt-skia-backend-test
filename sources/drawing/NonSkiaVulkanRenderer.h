...
#ifndef NONSKIAVULKANRENDERER_H
#define NONSKIAVULKANRENDERER_H

#include <QVulkanWindowRenderer>


class NonSkiaVulkanRenderer : public QVulkanWindowRenderer
{
public:
  NonSkiaVulkanRenderer(QVulkanWindow *w, bool msaa = false);
